...
const features = [
  { id: 1, name: '🔮 运势测试', icon: '🐴', desc: '测测你的马年运势', path: '/horoscope', needFollow: false, featured: true },
  { id: 2, name: 'AI拜年生成', icon: '📸', desc: '上传照片生成', path: '/generator', needFollow: false, hot: true },
  { id: 3, name: '在线烟花', icon: '🎆', desc: '许愿放烟花', path: '/firework', needFollow: false },
  { id: 4, name: '领取祝福', icon: '🧧', desc: '马年吉祥话', path: '/blessing', needFollow: false }
]
